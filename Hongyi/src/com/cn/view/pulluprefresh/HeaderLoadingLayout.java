package com.cn.view.pulluprefresh;
...
public class HeaderLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mRotateDownAnim = new RotateAnimation(toDegree,
                                              0.0f,
                                              Animation.RELATIVE_TO_SELF,
                                              pivotValue,
                                              Animation.RELATIVE_TO_SELF,
    ...
    protected void onPullToRefresh() {
        ...
        mHintTextView.setText(R.string.pull_to_refresh_header_hint_normal); // 下拉可以刷新
    }
    ...
    protected void onReleaseToRefresh() {
        ...
        mHintTextView.setText(R.string.pull_to_refresh_header_hint_ready);// 松开后刷新
    }
    ...
    protected void onRefreshing() {
        ...
        mHintTextView.setText(R.string.pull_to_refresh_header_hint_loading);// 正在加载中
    }
}
